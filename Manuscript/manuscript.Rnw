...
\author{\fnms{Joy H.} \snm{Lee}\ead[label=e1]{}}
\address{\printead{e1}}
\affiliation{Loyola University Chicago}

\and
\author{\fnms{Emily M.} \snm{Kotnik}\ead[label=e3]{}}
\address{\printead{e2}}
\affiliation{Loyola University Chicago}

\and
\author{\fnms{Gregory J.} \snm{Matthews}\corref{}\ead[label=e3]{gmatthews1@luc.edu}}
\address{\printead{e3}}
\affiliation{Loyola University Chicago}
