...
hist12 <- ggplot(res12) +
  ...
  geom_histogram(aes(x = value, fill = key), bins=100) +
  ggtitle("Fig 12Random* Samp, Pop D") +
  xlim(50000, 100000)
hist12
...
newplots <- list(hist1, hist2, hist3, hist4, hist5, hist6, hist7, hist8, hist9,
                 hist10, hist11, hist12,hist13, hist14, hist15, hist16, hist17)
save(hist2, file="/Users/joylee/Research Project/ConditionalRaking/CRplots2.rda")
